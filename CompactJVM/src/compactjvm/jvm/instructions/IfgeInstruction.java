...
public class IfgeInstruction {
     public static void run(StackFrame stackFrame) throws LoadingException{
        ...
        if(value.getValue() >= 0){
            ...
            JVMLogger.log(JVMLogger.TAG_INSTR_JUMP, "Ifge: "+value+" >= 0; goto "+nextInstruction);
        }else{
            JVMLogger.log(JVMLogger.TAG_INSTR_JUMP, "Ifge: "+value+" < 0");
        }
    }
}
